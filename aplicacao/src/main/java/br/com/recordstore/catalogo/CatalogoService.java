...
public class CatalogoService {
  ...
  public CatalogoService(MidiaRepository m, ExemplarRepository e, br.com.recordstore.emprestimos.EmprestimoRepository er){
    this.midiaRepo = m;
    this.exRepo = e;
    this.empRepo = er;
  }
  ...
  @Transactional
  public Midia catalogarMidia(Midia midia){
  ...
  public List<Midia> listarAcervo(){
    return midiaRepo.findAll();
  }

  private Boolean emprestado(Long exemplarId){
    return empRepo.existsByExemplarIdAndStatus(exemplarId, StatusEmprestimo.ATIVO);
  }
